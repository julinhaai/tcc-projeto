    ...
    <form id="form1" runat="server"> 
        <div class="form-box">
            ...
            <div id="divAluno" runat="server" visible="false">
                ...
                <asp:TextBox ID="txtRM" runat="server" CssClass="text" placeholder="Insira seu RM"></asp:TextBox>
                ...
                <asp:Label ID="lblObsAluno" runat="server" CssClass="label-obs"></asp:Label>
            </div>
            ...
            <div id="divUsuario" runat="server" visible="false">
                ...
                <asp:Label ID="lblObsUsuario" runat="server" CssClass="label-obs"></asp:Label>
            </div>
        </div>
    </form>
</body>
